<?php
  ...
  echo "<meta http-equiv=\"refresh\" content=\"10,URL=\FirstPHPProject\load.php\" />";
  ...
  if ($idleCpu > 50) {
    ...
    echo "Generating CPU Load! (auto refresh in 10 seconds)";
  }
  else {
    echo "Under High CPU Load! (auto refresh in 10 seconds)";
  }
?>
